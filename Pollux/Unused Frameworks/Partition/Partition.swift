...
////  Pollux
////
////  Created by Youssef Victor on 11/24/17.
...
//
//        // Combines all the indices from the different buffer
//        // into the scanned_result_buffer
//        case ADJUST
//        
//        // Partitions valid and invalids. Prob Bottleneck
//        case SCATTER
//    }
//
//    // *********************
...
//
//    // Adjusts the prefix scan result buffer by combining indices
//    private var kern_AdjustIndices          : MTLFunction!
//    private var ps_AdjustIndices            : MTLComputePipelineState!
//    
//    // Scatters items iinto their respective final positions
//    private var kern_Scatter                : MTLFunction!
//    private var ps_Scatter                  : MTLComputePipelineState!
//
//    //Buffers
//    private var validation_buffer    : DeviceBuffer<uint>?
//    private var scan_result_buffer   : DeviceBuffer<uint>?
//
//    // Buffer that stores a single element: The final count of the items
...
//        self.count_buffer        = SharedBuffer(count: 1, with: device)
//
...
//        self.dispatchPipelineStage(for: .ADJUST, using: commandEncoder)
//        
//        // Scatter the valid items to a new temporary array
//        self.dispatchPipelineStage(for: .SCATTER, using: commandEncoder)
//        
...
//        // Get the new count for the next iteration, if it's zero then just do nothing
//        let new_count = Int(self.count_buffer[0])
//        self.device_items.count = new_count == 0 ? self.device_items.count : new_count
...
//
//        kern_AdjustIndices    = self.library.makeFunction(name: "kern_AdjustIndices")
//        ps_AdjustIndices      = try device.makeComputePipelineState(function: kern_AdjustIndices!)
//        
//        kern_Scatter          = self.library.makeFunction(name: "kern_Scatter")
//        ps_Scatter            = try device.makeComputePipelineState(function: kern_Scatter!)
//    }
//
...
//
//        case .ADJUST:
//            commandEncoder.setComputePipelineState(ps_AdjustIndices)
//            commandEncoder.dispatchThreadgroups(self.threadgroupsPerGrid,
//                                                threadsPerThreadgroup: self.threadsPerThreadgroup)
//        case .SCATTER  :
//            commandEncoder.setComputePipelineState(ps_Scatter)
//            commandEncoder.dispatchThreadgroups(self.threadgroupsPerGrid,
//                                                threadsPerThreadgroup: self.threadsPerThreadgroup)
//            break
//        }
...
//            commandEncoder.setBuffer(       count_buffer.data,  offset: 0, index: 8)
//            break
//        case .SCATTER:
//            //Nothing, everything's already done
//            break
////        case .DEBUG:
