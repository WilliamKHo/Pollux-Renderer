...
void getIntersection(thread Ray ray,
                     ...
                     uint geom_count) {
    thread Intersection isect = intersection;
    getIntersection(ray, geoms, isect, geom_count);
    intersection = isect;
}

// Version of getIntersection that operates on a thread-space intersection.
void getIntersection(thread Ray ray,
                     device Geom* geoms,
